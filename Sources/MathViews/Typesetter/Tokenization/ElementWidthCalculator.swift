...
/// Measures the rendered width of ``BreakableElement`` content including inter-element spacing.
///
/// For text content, creates a temporary `CTLine` to measure the attributed string width.
/// For pre-rendered displays, reads the width directly from the ``Display`` object.
/// Spacing between adjacent elements follows the same TeX rules as the main typesetter.
