...
struct WidehatTests {
  ...
  @Test func widehatVsHat() throws {
    ...
    let hatDisplay = try #require(
      Typesetter.makeLineDisplay(for: hatMathList, font: font, style: .display))
    let widehatDisplay = try #require(
  ...
  @Test func widetildeVsTilde() throws {
    ...
    let tildeDisplay = try #require(
      Typesetter.makeLineDisplay(
        for: tildeMathList,
        font: font,
        style: .display,
      ))
    let widetildeDisplay = try #require(
      Typesetter.makeLineDisplay(
