...
struct MathListTests {
    ...
    func checkListCopy(_ copy: MathList?, original: MathList?, forTest test: String) {
        guard let copy, let original else { return }
        #expect(copy.atoms.count == original.atoms.count, "\(test)")
        for (i, copyAtom) in copy.atoms.enumerated() {
            let origAtom = original.atoms[i]
            checkAtomCopy(copyAtom, original: origAtom, forTest: test)
        }
    }
    ...
    @Test func copy() {
        ...
        checkListCopy(list2, original: list, forTest: "MathListTests")
    }
    ...
    @Test func atomCopy() {
        ...
        checkAtomCopy(copy, original: atom, forTest: "MathListTests")
        checkListCopy(copy.superScript, original: atom.superScript, forTest: "MathListTests")
        checkListCopy(copy.subScript, original: atom.subScript, forTest: "MathListTests")
    }
    ...
    @Test func copyFraction() {
        ...
        checkAtomCopy(copy, original: frac, forTest: "MathListTests")
        checkListCopy(copy.numerator, original: frac.numerator, forTest: "MathListTests")
        checkListCopy(copy.denominator, original: frac.denominator, forTest: "MathListTests")
        #expect(!copy.hasRule)
    ...
    @Test func copyRadical() {
        ...
        checkAtomCopy(copy, original: rad, forTest: "MathListTests")
        checkListCopy(copy.radicand, original: rad.radicand, forTest: "MathListTests")
        checkListCopy(copy.degree, original: rad.degree, forTest: "MathListTests")
    }
    ...
    @Test func copyLargeOperator() {
        ...
        checkAtomCopy(copy, original: lg, forTest: "MathListTests")
    ...
    @Test func copyInner() {
        ...
        checkAtomCopy(copy, original: inner, forTest: "MathListTests")
        checkListCopy(copy.innerList, original: inner.innerList, forTest: "MathListTests")
        checkAtomCopy(
            copy.leftBoundary,
    ...
    @Test func copyOverline() {
        ...
        checkAtomCopy(copy, original: over, forTest: "MathListTests")
        checkListCopy(copy.innerList, original: over.innerList, forTest: "MathListTests")
    }
    ...
    @Test func copyUnderline() {
        ...
        checkAtomCopy(copy, original: under, forTest: "MathListTests")
        checkListCopy(copy.innerList, original: under.innerList, forTest: "MathListTests")
    }

    @Test func copyAcccent() {
        let list = MathList()
        let atom = MathAtomFactory.placeholder()
        let atom2 = MathAtomFactory.times()
        let atom3 = MathAtomFactory.divide()
        ...
        checkAtomCopy(copy, original: accent, forTest: "MathListTests")
        checkListCopy(copy.innerList, original: accent.innerList, forTest: "MathListTests")
    }
    ...
    @Test func copySpace() {
        ...
        checkAtomCopy(copy, original: space, forTest: "MathListTests")
    ...
    @Test func copyStyle() {
        ...
        checkAtomCopy(copy, original: style, forTest: "MathListTests")
    ...
    @Test func copyMathTable() {
        ...
        checkAtomCopy(copy, original: table, forTest: "MathListTests")
        ...
        checkListCopy(copy.cells[0][1], original: list, forTest: "MathListTests")
        checkListCopy(copy.cells[0][2], original: list2, forTest: "MathListTests")
    }
}
