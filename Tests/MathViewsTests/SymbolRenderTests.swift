...
struct SymbolRenderTests {
  ...
  static let priority1SymbolCases: [RenderCase] = [
    ...
    RenderCase(
      name: "03_slanted_ineq", latex: #"a \leqslant b \leqslant c \quad x \geqslant y \geqslant z"#),
    ...
    RenderCase(
      name: "10_in_context", latex: #"f: A \longmapsto B, \quad x \leqslant y \implies \Box P"#),
  ]
