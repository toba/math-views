...
final class DiracRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_DiracTests_\(name).png")
...
final class OperatornameRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_OperatornameTests_\(name).png")
        try? pngData.write(to: url)
    }
...
final class BoldsymbolRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_BoldsymbolTests_\(name).png")
        try? pngData.write(to: url)
    }
...
final class BinaryOperatorRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_BinaryOpTests_\(name).png")
        try? pngData.write(to: url)
    }
...
final class CornerBracketRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_CornerBracketTests_\(name).png")
        try? pngData.write(to: url)
    }
...
final class TrigFunctionRenderTests: XCTestCase {
    ...
    func saveImage(named name: String, pngData: Data) {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("MathViews_TrigTests_\(name).png")
        try? pngData.write(to: url)
    }
