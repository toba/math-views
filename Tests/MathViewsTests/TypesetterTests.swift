...
@MainActor struct TypesetterTests {
  ...
  @Test func largeOpNoLimitsSymbol() {
    let mathList = MathList()
  ...
  @Test func largeOpNoLimitsSymbolWithScripts() throws {
    ...
    #expect(!displaysBelowBaseline.isEmpty, "Should have display(s) below baseline for subscript")
  ...
  @Test func largeOpWithLimitsInlineMode_Limit() throws {
    ...
    #expect(
      limDisplay is LargeOpLimitsDisplay, "Limit should use LargeOpLimitsDisplay in inline mode")
  ...
  @Test func largeOpWithLimitsInlineMode_Sum() throws {
    ...
    #expect(
      sumDisplay is LargeOpLimitsDisplay, "Sum should use LargeOpLimitsDisplay in inline mode")
  ...
  @Test func largeOpWithLimitsInlineMode_Product() throws {
    ...
    #expect(
      prodDisplay is LargeOpLimitsDisplay, "Product should use LargeOpLimitsDisplay in inline mode")
  ...
  @Test func spacing() throws {
    ...
    let noSpaceDisplay = try #require(
      Typesetter.createLineForMathList(noSpace, font: self.font, style: .display))
  ...
  @Test func latexSymbols() {
    ...
    for symName in allSymbols {
      ...
      guard let display = Typesetter.createLineForMathList(list, font: self.font, style: .display)
      else {
  ...
  @Test func styleChanges() {
    ...
    #expect(
      originalDisplay.ascent > display.ascent, "Display mode fractions have more vertical spacing")
    #expect(
      originalDisplay.descent > display.descent, "Display mode fractions have more vertical spacing"
    )
  }
  ...
  @Test func styleMiddle() throws {
    ...
    let display = try #require(
      Typesetter.createLineForMathList(list, font: self.font, style: .display))
    #expect(display != nil)
    #expect(display.type == .regular)
    #expect(CGPointEqualToPoint(display.position, CGPoint.zero))
  ...
  @Test func vectorArrowRendering() throws {
    ...
    for cmd in commands {
      ...
      #expect(
        accentVisualBottom >= 0, "\\\(cmd) accent visual bottom should be at or above accentee")
    }
  }
  ...
  @Test func singleCharacterAccentsWithLineWrapping() throws {
    ...
    let display = try #require(
      Typesetter.createLineForMathList(
        mathList, font: self.font, style: .display, maxWidth: maxWidth)
    )
  ...
  @Test func interatomLineBreaking_SimpleEquation() {
    ...
    #expect(
      display!.subDisplays.count > 1, "Expected multiple lines with width constraint of \(maxWidth)"
    )
  ...
  @Test func interatomLineBreaking_TextAndMath() {
  ...
  @Test func interatomLineBreaking_BreaksAtAtomBoundaries() {
  ...
  @Test func interatomLineBreaking_WithSuperscripts() {
  ...
  @Test func interatomLineBreaking_NoBreakingWhenNotNeeded() {
  ...
  @Test func interatomLineBreaking_BreaksAfterOperators() {
  ...
  @Test func complexDisplay_FractionStaysInlineWhenFits() {
  ...
  @Test func complexDisplay_FractionBreaksWhenTooWide() {
  ...
  @Test func complexDisplay_RadicalStaysInlineWhenFits() {
  ...
  @Test func complexDisplay_RadicalBreaksWhenTooWide() {
  ...
  @Test func complexDisplay_MixedFractionsAndRadicals() {
  ...
  @Test func complexDisplay_FractionWithComplexNumerator() {
  ...
  @Test func complexDisplay_RadicalWithDegree() {
    // Cube root
  ...
  @Test func complexDisplay_NoBreakingWithoutWidthConstraint() {
    ...
    var allAtSameY = true
    let firstY = display!.subDisplays.first?.position.y ?? 0
    for subDisplay in display!.subDisplays where abs(subDisplay.position.y - firstY) > 0.1 {
      allAtSameY = false
      break
    }
  ...
  @Test func edgeCase_VeryNarrowWidth() {
    ...
    #expect(!display!.subDisplays.isEmpty, "Should produce at least one display")
    ...
    for subDisplay in display!.subDisplays {
      ...
      #expect(
        subDisplay.width < maxWidth * 3, "Width shouldn't be excessively larger than constraint")
    }
  }

  @Test func edgeCase_VeryWideAtom() {
  ...
  @Test func mixedScriptsAndNonScripts() {
  ...
  @Test func multipleLineBreaks() {
    ...
    let uniqueYPositions = Set(display!.subDisplays.map(\.position.y)).sorted(by: >)
  ...
  @Test func unicodeTextWrapping() {
    ...
    for subDisplay in display!.subDisplays {
      ...
      #expect(
        subDisplay.width <= maxWidth * 1.5, "Unicode text line should respect width reasonably")
    }
  }

  @Test func numberProtection() {
  ...
  @Test func currentBehavior_LargeOperators() {
  ...
  @Test func currentBehavior_NestedDelimiters() {
  ...
  @Test func currentBehavior_ColoredExpressions() {
  ...
  @Test func currentBehavior_MatricesWithSurroundingContent() {
  ...
  @Test func realWorldExample_QuadraticFormula() {
  ...
  @Test func realWorldExample_ComplexFraction() {
  ...
  @Test func realWorldExample_MixedOperationsWithFractions() {
  ...
  @Test func complexDisplay_LargeOperatorStaysInlineWhenFits() {
    ...
    let display = Typesetter.createLineForMathList(
      mathList, font: self.font, style: .text, maxWidth: maxWidth)
    #expect(display != nil)
  ...
  @Test func complexDisplay_LargeOperatorBreaksWhenTooWide() {
  ...
  @Test func complexDisplay_MultipleLargeOperators() {
  ...
  @Test func complexDisplay_DelimitersStayInlineWhenFit() {
  ...
  @Test func complexDisplay_DelimitersBreakWhenTooWide() {
  ...
  @Test func complexDisplay_NestedDelimitersWithWrapping() {
  ...
  @Test func complexDisplay_MultipleDelimiters() {
  ...
  @Test func complexDisplay_ColoredExpressionStaysInlineWhenFits() {
  ...
  @Test func complexDisplay_ColoredExpressionBreaksWhenTooWide() {
  ...
  @Test func complexDisplay_MultipleColoredSections() {
  ...
  @Test func complexDisplay_SmallMatrixStaysInlineWhenFits() {
  ...
  @Test func complexDisplay_MatrixBreaksWhenTooWide() {
    ...
    for (index, subDisplay) in display!.subDisplays.enumerated() {
      #expect(
        subDisplay.width <= maxWidth * 1.5, "Line \(index) should roughly respect width constraint")
    }
  }

  @Test func complexDisplay_MatrixWithSurroundingContent() {
  ...
  @Test func complexDisplay_MixedComplexElements() {
  ...
  @Test func complexDisplay_RealWorldQuadraticWithColor() {
  ...
  @Test func sumEquationWithFraction_CorrectOrdering() {
  ...
  @Test func sumEquationWithFraction_WithWidthConstraint() {
  ...
  @Test func scriptedAtoms_StayInlineWhenFit() {
    ...
    var yPositions = display!.subDisplays.map(\.position.y).sorted()
  ...
  @Test func scriptedAtoms_BreakWhenTooWide() {
  ...
  @Test func mixedScriptedAndNonScripted() {
  ...
  @Test func subscriptsAndSuperscripts() {
  ...
  @Test func realWorld_QuadraticExpansion() {
  ...
  @Test func realWorld_Polynomial() {
  ...
  @Test func scriptedAtoms_NoBreakingWithoutConstraint() {
    ...
    // No width constraint (maxWidth = 0)
    let display = Typesetter.createLineForMathList(
      mathList, font: self.font, style: .display, maxWidth: 0)
    #expect(display != nil)
  ...
  @Test func complexScriptedExpression() {
  ...
  @Test func breakQuality_PreferAfterBinaryOperator() {
    ...
    #expect(
      hasGoodBreak, "Break should occur after binary operator +, found lines: \(lineContents)")
  }

  @Test func breakQuality_PreferAfterRelation() {
    ...
    let hasGoodBreak = lineContents.contains { $0.contains("=") }
    #expect(
      hasGoodBreak, "Break should occur after relation operator =, found lines: \(lineContents)")
  }

  @Test func breakQuality_AvoidAfterOpenBracket() {
  ...
  @Test func breakQuality_LookAheadFindsBetterBreak() {
    ...
    let hasGoodBreak = lineContents.contains { $0.contains("+") }
    #expect(
      hasGoodBreak, "Look-ahead should find better break after +, found lines: \(lineContents)")
  }

  @Test func breakQuality_MultipleOperators() {
  ...
  @Test func breakQuality_ComplexExpression() {
  ...
  @Test func breakQuality_NoBreakWhenNotNeeded() {
  ...
  @Test func breakQuality_PenaltyOrdering() {
  ...
  @Test func dynamicLineHeight_TallContentHasMoreSpacing() {
  ...
  @Test func dynamicLineHeight_RegularContentHasReasonableSpacing() {
    ...
    for spacing in spacings {
      ...
      #expect(
        spacing <= self.font.fontSize * 2.0, "Spacing should not be excessive for regular content")
    }
  }

  @Test func dynamicLineHeight_MixedContentVariesSpacing() {
  ...
  @Test func dynamicLineHeight_LargeOperatorsGetAdequateSpace() {
  ...
  @Test func dynamicLineHeight_ConsistentWithinSimilarContent() {
  ...
  @Test func dynamicLineHeight_NoRegressionOnSingleLine() {
  ...
  @Test func dynamicLineHeight_DeepFractionsGetExtraSpace() {
  ...
  @Test func dynamicLineHeight_RadicalsWithIndicesGetSpace() {
  ...
  @Test func tableCellLineBreaking_MultipleFractions() {
  ...
  @Test func tableCellLineBreaking_ThreeRowsWithPowers() {
  ...
  @Test func invalidFractionRangeHandling() {
    ...
    let nestedDisplay = Typesetter.createLineForMathList(
      nestedMathList, font: self.font, style: .display)
    ...
    let tableDisplay = Typesetter.createLineForMathList(
      tableMathList, font: self.font, style: .display, maxWidth: 200)
  ...
  @Test func atomWidthIncludesScripts() {
    ...
    let superscriptDisplay = Typesetter.createLineForMathList(
      superscriptMathList, font: self.font, style: .text, maxWidth: 100)
    ...
    let baseOnlyDisplay = Typesetter.createLineForMathList(
      baseOnlyMathList, font: self.font, style: .text)
    ...
    let subscriptDisplay = Typesetter.createLineForMathList(
      subscriptMathList, font: self.font, style: .text)
    #expect(
    ...
    let longDisplay = Typesetter.createLineForMathList(
      longMathList, font: self.font, style: .text, maxWidth: 150)
  ...
  @Test func safeUIntConversionFromNSRange() throws {
    ...
    let fractionDisplay = Typesetter.createLineForMathList(
      fractionMathList, font: self.font, style: .display)
    ...
    let radicalDisplay = Typesetter.createLineForMathList(
      radicalMathList, font: self.font, style: .display)
    ...
    let accentDisplay = Typesetter.createLineForMathList(
      accentMathList, font: self.font, style: .text)
    ...
    let complexDisplay = Typesetter.createLineForMathList(
      complexMathList, font: self.font, style: .display)
    #expect(
      complexDisplay != nil,
      "Should handle complex expression with various scripted atoms without crash")
  ...
  @Test func negativeNumberAfterRelation() throws {
    ...
    let simpleDisplay = Typesetter.createLineForMathList(
      simpleMathList, font: self.font, style: .display)
    ...
    let decimalDisplay = Typesetter.createLineForMathList(
      decimalMathList, font: self.font, style: .display)
    ...
    let complexDisplay = Typesetter.createLineForMathList(
      complexMathList, font: self.font, style: .display, maxWidth: 300)
    #expect(
      complexDisplay != nil,
      "Should create display for determinant/matrix expression without assertion")
    ...
    let multipleDisplay = Typesetter.createLineForMathList(
      multipleMathList, font: self.font, style: .text)
    ...
    let relationDisplay = Typesetter.createLineForMathList(
      relationMathList, font: self.font, style: .text)
