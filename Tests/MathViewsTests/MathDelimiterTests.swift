...
struct MathDelimiterTests {
    ...
    @Test func doubleDollarDisplayMath() throws {
        // Test $$...$$ delimiter for display math
    ...
    @Test func inlineMathParentheses() throws {
    ...
    @Test func singleDollarInlineMath() throws {
        // Test $...$ delimiter for inline math
        let latex = "$\\frac{1}{2}$"
        let (mathList, style) = MathListBuilder.buildWithStyle(fromString: latex)
    ...
    @Test func noDelimitersDefaultsToDisplay() throws {
    ...
    @Test func emptyBrackets() throws {
        // Test empty \[...\]
        ...
        #expect(style == .display, "\\[ \\] should produce display style")
        #expect(mathList?.atoms.count == 0, "Empty delimiters should produce empty list")
    }

    @Test func emptyDoubleDollar() throws {
        // Test empty $$...$$
        let latex = "$$$$"
        let (mathList, style) = MathListBuilder.buildWithStyle(fromString: latex)
    ...
    @Test func whitespaceInBrackets() throws {
    ...
    @Test func nestedBracesInDisplayMath() throws {
    ...
    @Test func complexDisplayExpression() throws {
    ...
    @Test func invalidLatexWithBrackets() throws {
        // Test \[...\] with invalid LaTeX
        let latex = "\\[\\invalidcommand\\]"
        var error: NSError?
        let (mathList, style) = MathListBuilder.buildWithStyle(fromString: latex, error: &error)

        #expect(mathList == nil, "Invalid LaTeX should return nil")
        #expect(error != nil, "Should return an error")
        #expect(style == .display, "Style should still be detected even with error")
    }

    @Test func mismatchedDelimiters() throws {
    ...
    @Test func backwardCompatibilityWithOldAPI() throws {
    ...
    @Test func backwardCompatibilityWithError() throws {
    ...
    func allDisplayDelimiters(_ latex: String) throws {
    ...
    func allInlineDelimiters(_ latex: String) throws {
    ...
    @Test func environmentDefaultsToDisplay() throws {
