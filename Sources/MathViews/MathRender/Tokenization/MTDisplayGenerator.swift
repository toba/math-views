...
class DisplayGenerator {
    ...
    init(font: MTFont, style: LineStyle) {
        self.font = font
        self.style = style
    ...
    private func generateLine(_ elements: [BreakableElement], at position: CGPoint) -> ([Display], LineMetrics) {
    ...
    private func renderGroup(_ groupElements: [BreakableElement], at position: CGPoint, displays: inout [Display]) -> CGFloat {
        ...
        var superscriptDisplay: Display? = nil
        var subscriptDisplay: Display? = nil
        ...
        for disp in displays[baseDisplayStartIndex..<displays.count] {
            if disp is GlyphDisplay {
                isGlyphBase = true
                // Get script font metrics for display-based positioning
                let scriptStyle: LineStyle = (style == .display || style == .text) ? .script : .scriptOfScript
    ...
    private func createTextDisplay(_ text: String, at position: CGPoint, element: BreakableElement, hasScript: Bool = false) -> Display {
