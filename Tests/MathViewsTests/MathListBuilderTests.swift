...
struct TestRecord: Sendable, CustomTestStringConvertible {
  ...
  static let superSubScriptCases: [TestRecord] = [
    ...
    TestRecord(
      ...
      result: "x^{*}_{2}"),
    TestRecord(
      build: "x_^*", atomType: [.variable], types: [], extra: [.binaryOperator], result: "x^{*}_{}"),
...
struct ParseErrorRecord: Sendable, CustomTestStringConvertible {
  ...
  static let parseErrorCases: [ParseErrorRecord] = [
    ...
    ParseErrorRecord(input: "\\begin{matrix} x \\end{", expectedError: .characterNotFound),  // missing }
    ParseErrorRecord(
      input: "\\begin{matrix} x \\end{matrix + 3", expectedError: .characterNotFound),  // missing }
    ...
    ParseErrorRecord(
      input: "\\begin{displaylines} x & y \\end{displaylines}", expectedError: .invalidNumColumns),
