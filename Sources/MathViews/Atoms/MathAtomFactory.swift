...
public enum MathAtomFactory {
    ...
    public static func fraction(
        withNumerator numerator: MathList,
    ...
    ///
    /// Standard TeX inter-column spacing in mu (1em = 18mu).
    private static let standardColumnSpacing: CGFloat = 18
    /// Compact inter-column spacing for `smallmatrix` in mu.
    private static let compactColumnSpacing: CGFloat = 6
    ...
    public static func table(
        ...
        if env == nil {
            ...
            if let delimiters = matrixEnvs[env] {
                ...
                table.interColumnSpacing = isSmallMatrix ? compactColumnSpacing : standardColumnSpacing
                ...
                table.interRowAdditionalSpacing = 1
                table.interColumnSpacing = standardColumnSpacing
