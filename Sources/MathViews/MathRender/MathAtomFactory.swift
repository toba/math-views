...
public enum MathAtomFactory {
    ...
    public static let delimValueToName: [String: String] = buildReverseMapping(delimiters)
    ...
    public static func atom(forCharacter ch: Character) -> MathAtom? {
        ...
        switch chStr {
            ...
            default:
                assertionFailure(
                    "Unknown ASCII character '\(ch)'. Should have been handled earlier.",
                )
                return nil
        }
    }
    ...
    public static func fraction(withNumerator num: MathList,
                                denominator denom: MathList) -> Fraction
    {
        let frac = Fraction()
        frac.numerator = num
    ...
    public static func fraction(
        withNumeratorString numStr: String, denominatorString denomStr: String,
    ) -> Fraction {
