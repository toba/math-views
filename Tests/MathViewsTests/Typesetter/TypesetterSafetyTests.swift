...
struct TypesetterSafetyTests {
    ...
    @Test func invalidFractionRangeHandling() throws {
        ...
        let nestedDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        _ = try #require(Typesetter.makeLineDisplay(
    ...
    @Test func atomWidthIncludesScripts() throws {
        ...
        let superscriptDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let baseOnlyDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let subscriptDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let bothDisplay = try #require(Typesetter.makeLineDisplay(for: bothMathList, font: font, style: .text))
        #expect(
        ...
        let longDisplay = try #require(Typesetter.makeLineDisplay(
    ...
    @Test func safeUIntConversionFromNSRange() throws {
        ...
        let complexDisplay = try #require(Typesetter.makeLineDisplay(
    ...
    @Test func negativeNumberAfterRelation() throws {
        ...
        let simpleDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let decimalDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let multipleDisplay = try #require(Typesetter.makeLineDisplay(
        ...
        let relationDisplay = try #require(Typesetter.makeLineDisplay(
