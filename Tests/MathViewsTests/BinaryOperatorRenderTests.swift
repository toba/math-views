...
struct BinaryOperatorRenderTests {
    ...
    func semidirectProducts(_ renderCase: RenderCase) throws {
    ...
    func circledAndBoxedOperators(_ renderCase: RenderCase) throws {
        let result = MathImageResult.useMathImage(latex: renderCase.latex, font: font, fontSize: fontSize)
    ...
    func logicalOperators(_ renderCase: RenderCase) throws {
        let result = MathImageResult.useMathImage(latex: renderCase.latex, font: font, fontSize: fontSize)
