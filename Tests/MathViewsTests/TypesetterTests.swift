...
@MainActor struct TypesetterTests {
    ...
    @Test func interatomLineBreaking_SimpleEquation() throws {
        ...
        let uniqueYPositions = try Set(#require(display?.subDisplays.map(\.position.y)))
        if try #require(display?.width) > maxWidth * 0.9 {
    ...
    @Test func interatomLineBreaking_TextAndMath() throws {
        ...
        let uniqueYPositions = try Set(#require(display?.subDisplays.map(\.position.y)))
        if try #require(display?.width) > maxWidth * 0.9 || display!.subDisplays.count > 5 {
    ...
    @Test func interatomLineBreaking_NoBreakingWhenNotNeeded() throws {
        ...
        #expect(
            try #require(display?.width) < maxWidth,
    ...
    @Test func interatomLineBreaking_BreaksAfterOperators() throws {
        ...
        #expect(try #require(display?.subDisplays.count) > 1, "Expected multiple lines")
    ...
    @Test func complexDisplay_FractionStaysInlineWhenFits() throws {
        ...
        let firstY = try #require(display?.subDisplays.first?.position.y) ?? 0
        for subDisplay in try #require(display?.subDisplays) {
            #expect(
        ...
        let displayWidth = try #require(display?.width)
        #expect(
    ...
    @Test func complexDisplay_FractionWithComplexNumerator() throws {
        ...
        #expect(
            try #require(display?.width) < maxWidth * 1.5,
    ...
    @Test func complexDisplay_RadicalWithDegree() throws {
        ...
        #expect(
            try #require(display?.width) < maxWidth * 1.2,
    ...
    @Test func edgeCase_VeryNarrowWidth() throws {
        ...
        #expect(
            try !#require(display?.subDisplays.isEmpty),
    ...
    @Test func edgeCase_VeryWideAtom() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Should produce display")
    ...
    @Test func multipleLineBreaks() throws {
        ...
        #expect(
            try #require(display?.subDisplays.count) >= 4,
    ...
    @Test func realWorldExample_QuadraticFormula() throws {
        ...
        #expect(try #require(display?.width) > 0, "Formula has non-zero width")
    }
    ...
    @Test func realWorldExample_MixedOperationsWithFractions() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Multiple fractions render")
    ...
    @Test func complexDisplay_LargeOperatorStaysInlineWhenFits() throws {
        ...
        let lineCount = try #require(display?.subDisplays.count)
    ...
    @Test func complexDisplay_MultipleLargeOperators() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Operators render")
    ...
    @Test func complexDisplay_NestedDelimitersWithWrapping() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Delimiters render")
    ...
    @Test func complexDisplay_MatrixWithSurroundingContent() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Matrix renders")
    ...
    @Test func complexDisplay_RealWorldQuadraticWithColor() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Complex formula renders")
    ...
    @Test func sumEquationWithFraction_CorrectOrdering() throws {
        ...
        let subDisplays = try #require(display?.subDisplays)
    ...
    @Test func scriptedAtoms_StayInlineWhenFit() throws {
        ...
        var yPositions = try #require(display?.subDisplays.map(\.position.y).sorted())
    ...
    @Test func subscriptsAndSuperscripts() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Should have content")
    ...
    @Test func realWorld_QuadraticExpansion() throws {
        ...
        // Should fit on reasonable number of lines
        #expect(try !#require(display?.subDisplays.isEmpty), "Quadratic expansion should render")
    ...
    @Test func realWorld_Polynomial() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Polynomial should render")
    ...
    @Test func complexScriptedExpression() throws {
        ...
        // Should render successfully
        #expect(try !#require(display?.subDisplays.isEmpty), "Complex expression should render")
    ...
    @Test func dynamicLineHeight_TallContentHasMoreSpacing() throws {
        ...
        let yPositions = try Set(#require(display?.subDisplays.map(\.position.y))).sorted(by: >)
    ...
    @Test func dynamicLineHeight_MixedContentVariesSpacing() throws {
        ...
        let totalHeight = try #require(display?.ascent) + display!.descent
    ...
    @Test func tableCellLineBreaking_MultipleFractions() throws {
        ...
        #expect(try !#require(display?.subDisplays.isEmpty), "Should have subdisplays")
        ...
        if let tableDisplay = try #require(display?.subDisplays[0]) as? MathListDisplay {
        ...
        #expect(try #require(display?.ascent) > 0, "Display should have positive ascent")
    }
    ...
    @Test func tableCellLineBreaking_ThreeRowsWithPowers() throws {
        ...
        #expect(try #require(display?.width) > 0, "Display should have positive width")
        #expect(try #require(display?.ascent) > 0, "Display should have positive ascent")
        #expect(try #require(display?.descent) > 0, "Display should have positive descent")
    }
    ...
    @Test func invalidFractionRangeHandling() throws {
        ...
        #expect(try #require(display?.width) > 0, "Fraction should have positive width")
        #expect(try #require(display?.ascent) > 0, "Fraction should have positive ascent")
        ...
        #expect(
            try #require(nestedDisplay?.width) > 0,
    ...
    @Test func atomWidthIncludesScripts() throws {
        ...
        #expect(
            try #require(superscriptDisplay?.width) > baseOnlyDisplay!.width,
        ...
        let longDisplayWidth = try #require(longDisplay?.width)
        #expect(
    ...
    @Test func safeUIntConversionFromNSRange() throws {
        ...
        #expect(
            try #require(complexDisplay?.width) > 0,
    ...
    @Test func negativeNumberAfterRelation() throws {
        ...
        #expect(try #require(complexDisplay?.width) > 0, "Display should have positive width")
