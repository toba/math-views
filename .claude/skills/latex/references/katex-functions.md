...
- [ ] `\negmedspace` — negative medium space (not implemented)
- [ ] `\negthickspace` — negative thick space (not implemented)
- [ ] `\enspace` — en-space (not implemented)
...
- [ ] `\mkern{distance}` — math kerning (not implemented)
