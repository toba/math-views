...
struct WidehatTests {
    ...
    @Test func widehatVsHat() throws {
        ...
        let widehatDisplay = Typesetter.createLineForMathList(widehatMathList, font: font, style: .display)
        ...
        #expect(widehatAccent.width > hatAccent.width,
                "\\widehat should be wider than \\hat for multi-character content")
    }

    @Test func widetildeVsTilde() throws {
        ...
        let widetildeDisplay = Typesetter.createLineForMathList(widetildeMathList, font: font, style: .display)
        ...
        #expect(widetildeAccent.width > tildeAccent.width,
                "\\widetilde should be wider than \\tilde for multi-character content")
    }

    // MARK: - Coverage Tests

    @Test func widehatSingleCharCoverage() throws {
    ...
    func widehatMultiCharCoverage(_ testCase: WidehatCase) throws {
    ...
    @Test func widetildeCoverage() throws {
    ...
    @Test func isWideFlagSet() throws {
    ...
    @Test func widehatWithFraction() throws {
    ...
    @Test func widehatWithSubscript() throws {
    ...
    @Test func widehatWithSuperscript() throws {
    ...
    @Test func widehatVerticalSpacing() throws {
        ...
        #expect(accentDisp.ascent > accentDisp.accentee?.ascent ?? 0,
                "Accent display should be taller than content alone")
    }

    // MARK: - Backward Compatibility Tests

    @Test func hatStillWorks() throws {
    ...
    @Test func tildeStillWorks() throws {
    ...
    @Test func widehatVeryLongContent() throws {
