...
struct AccentSpacingComparisonTest {
    ...
    @Test func compareSpacing() throws {
        ...
        let arrowDisplay = Typesetter.createLineForMathList(arrowMathList, font: font, style: .display)
        ...
        if let widehatGlyphDisp = widehatAccent as? GlyphDisplay,
        ...
        if let arrowGlyphDisp = arrowAccent as? GlyphDisplay,
