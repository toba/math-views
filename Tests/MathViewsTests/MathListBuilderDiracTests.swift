...
struct MathListBuilderDiracTests {
    ...
    @Test func braketCommand() throws {
    ...
    @Test func diracInExpression() throws {
    ...
    @Test func braketWithComplexContent() throws {
    ...
    @Test func operatornameCommand() throws {
    ...
    @Test func operatornameStarCommand() throws {
    ...
    @Test func operatornameInExpression() throws {
    ...
    @Test func operatornameWithSubscript() throws {
