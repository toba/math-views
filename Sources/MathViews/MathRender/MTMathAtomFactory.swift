        ...
        if env == nil {
            ...
            if let delims = matrixEnvs[env] {
                ...
                if env == "split" && table.numColumns > 2 {
                    ...
                    if error == nil {
                        error = NSError(domain: MTParseError, code: ParseErrors.invalidNumColumns.rawValue, userInfo: [NSLocalizedDescriptionKey:message])
                    }
                    return nil
                }
                ...
                error = NSError(domain: MTParseError, code: ParseErrors.invalidEnv.rawValue, userInfo: [NSLocalizedDescriptionKey:message])
                return nil
            }
        }
        return nil
