...
struct TypesetterTests {
    ...
    @Test func styleChanges() throws {
        ...
        let originalDisplay = try #require(
            Typesetter.makeLineDisplay(
                for: list,
                font: font,
                style: .display,
